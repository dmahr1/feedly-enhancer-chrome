...
function fixTabs(){
    ...
    $('#integrationstab_icon').attr('title', capitalizeFirstLetter($('#integrationstab_label').text())); //dmahr
...
function buildMenu(){
	...
	menuHolder.append(menuTop).append(menuBottom).appendTo('#feedlyTabs'); //dmahr
...
function compactTopLeftPane(toCompact){
    ...
    if(toCompact){
        ...
        //dmahr changes below
        $('#librarytab_label').addClass('feHideElement');
        $('#librarytab').addClass('feInlineBlock');
        var bottomMatter = $('#moreTabs').parent()
        $('#mytab').parent().detach().prependTo(bottomMatter);
        $('.secondaryPanelButton').detach().prependTo(bottomMatter);  
        ...
        $('#integrationstab_header').removeClass('feInlineBlock');
        $('#exploretab').removeClass('feInlineBlock');
        $('#organizetab').removeClass('feInlineBlock');
        $('#latesttab').parent().removeClass('feMarginTopMinus5');
        
        //dmahr changes below
        $('#librarytab_label').removeClass('feHideElement');
        $('#librarytab').removeClass('feInlineBlock');
